...
F0/F0-SK e F1 estão implementados e aguardam auditoria independente. O template em
`templates/gold` passa no `check` e em testes mínimos; F2–F5 permanecem não iniciadas.
